...
_Python package_: to add and install this package as a dependency of your project, run `poetry add sankey-streamlit`.
...
1. ⭐️ _Dev Container (with container volume)_: click on [Open in Dev Containers](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/avsthiago/sankey-streamlit) to clone this repository in a container volume and create a Dev Container with VS Code.
